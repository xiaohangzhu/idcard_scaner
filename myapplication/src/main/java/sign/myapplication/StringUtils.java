...
public class StringUtils {
    ...
    public static String icCardFormat(String icCard) {
        if (icCard == null || icCard.length() < 11) {
            return icCard;
        }
        char[] charArray = icCard.toCharArray();
    ...
    public static String icCardFormat4(String icCard) {
        ...
        icCard = icCard.substring(icCard.length() - 4, icCard.length());
        return icCard;
